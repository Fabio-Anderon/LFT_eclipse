...
public final class AMaiorIgualOpComparar extends POpComparar
{
    private TMaiorIgual _maiorIgual_;

    public AMaiorIgualOpComparar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMaiorIgualOpComparar(
    ...
    {
        ((Analysis) sw).caseAMaiorIgualOpComparar(this);
    }
