...
public final class AMenorIgualOpComparar extends POpComparar
{
    private TMenorIgual _menorIgual_;

    public AMenorIgualOpComparar()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AMenorIgualOpComparar(
    ...
    {
        ((Analysis) sw).caseAMenorIgualOpComparar(this);
    }
