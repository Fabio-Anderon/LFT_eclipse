...
public final class AExpComparacao extends PExpComparacao
{
    ...
    private POpComparar _opComparar_;
    ...
    public AExpComparacao(
        ...
        @SuppressWarnings("hiding") POpComparar _opComparar_,
        @SuppressWarnings("hiding") PExp _direita_)
    {
        // Constructor
        setEsquerda(_esquerda_);

        setOpComparar(_opComparar_);
    ...
    public POpComparar getOpComparar()
    {
        return this._opComparar_;
    }

    public void setOpComparar(POpComparar node)
    {
        if(this._opComparar_ != null)
        {
            this._opComparar_.parent(null);
        }
    ...
    void removeChild(@SuppressWarnings("unused") Node child)
    {
        ...
        if(this._opComparar_ == child)
        {
            this._opComparar_ = null;
            return;
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._opComparar_ == oldChild)
        {
            setOpComparar((POpComparar) newChild);
            return;
        }
