...
public final class AExpLogicaExpGlobal extends PExpGlobal
{
    private TAbreParantes _abreParantes_;
    private PExpLogica _expLogica_;
    private TFechaParentes _fechaParentes_;

    public AExpLogicaExpGlobal()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AExpLogicaExpGlobal(
    ...
    {
        ((Analysis) sw).caseAExpLogicaExpGlobal(this);
    }
