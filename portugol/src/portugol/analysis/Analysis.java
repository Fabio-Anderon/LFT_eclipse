...
public interface Analysis extends Switch
{
    ...
    void caseAMenosExpGlobalExpGlobal(AMenosExpGlobalExpGlobal node);
    void caseASomaExpGlobal(ASomaExpGlobal node);
    void caseAExpLogicaExpGlobal(AExpLogicaExpGlobal node);
    void caseAProdutoTermo(AProdutoTermo node);
    void caseAExpGlobalParentesFator(AExpGlobalParentesFator node);
    ...
    void caseAComparacaoExpLogica(AComparacaoExpLogica node);
    void caseAExpXorExpLogica(AExpXorExpLogica node);
    void caseAExpNaoExpLogica(AExpNaoExpLogica node);
    void caseAXorExpXor(AXorExpXor node);
    void caseAExpOuExpXor(AExpOuExpXor node);
    void caseAOuExpOu(AOuExpOu node);
    void caseAExpEExpOu(AExpEExpOu node);
    void caseAExpE(AExpE node);
    void caseAExpNao(AExpNao node);
    void caseAMaiorOpComparacao(AMaiorOpComparacao node);
    void caseAMenorOpComparacao(AMenorOpComparacao node);
    void caseAIgualOpComparacao(AIgualOpComparacao node);
    void caseADiferenteOpComparacao(ADiferenteOpComparacao node);
    void caseAMaiorIgualOpComparacao(AMaiorIgualOpComparacao node);
    void caseAMenorIgualOpComparacao(AMenorIgualOpComparacao node);
