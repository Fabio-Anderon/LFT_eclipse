...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTProduto(@SuppressWarnings("unused") TProduto node)
    {
        this.index = 30;
    }
    ...
    @Override
    public void caseTDoisPts(@SuppressWarnings("unused") TDoisPts node)
    {
        this.index = 34;
    }
    ...
    @Override
    public void caseTAbreParantes(@SuppressWarnings("unused") TAbreParantes node)
    {
        this.index = 36;
    }

    @Override
    public void caseTFechaParentes(@SuppressWarnings("unused") TFechaParentes node)
    {
        this.index = 37;
    }
    ...
    @Override
    public void caseTComentEscopo(@SuppressWarnings("unused") TComentEscopo node)
    {
        this.index = 54;
    }
